...
class UserRepository(
    ...
    fun getUserMedicalHistory(userId: Long): Flow<List<DiseaseInfo>> {
        return userDao.getUserWithDiseases(userId).map { userWithDiseases ->
            userWithDiseases?.diseases ?: emptyList()
        }
    }
}